...
/* ---- data/1QWU6APGTFRynSmNA53qgCaVAxpVA9nYa/js/lib/EpixFrame.coffee ---- */
...
(function() {
  ...
  EpixFrame = (function() {
    ...
    EpixFrame.prototype.route = function(cmd, message) {
    ...
    EpixFrame.prototype.log = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return console.log.apply(console, ["[EpixFrame]"].concat(__slice.call(args)));
    };
